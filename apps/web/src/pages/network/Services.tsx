  ...
  const serviceTypes = [
    {
      ...
      services: [
        ...
        {
          title: "Nursery Setup & Preparation at Mummy's Whispers with Caroline",
          description: "Professional nursery setup ensuring perfect preparation for baby's arrival",
        ...
        },
        {
          ...
          description: 'Specialized care for complex pregnancies and maternal-fetal medicine',
          location: 'East Melbourne, VIC',
          price: 'From $450',
          provider: 'Dr. Shelley Rowlands',
          center: 'EMOG',
    ...
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          description: 'Comprehensive newborn care, sleep routines, and family transition guidance',
          location: 'Double Bay, NSW',
          price: 'From $325',
          provider: 'Caroline Johnson',
          center: "Mummy's Whispers",
        ...
        },
        {
          ...
          description: '14-day comprehensive sleep training using gentle, personalized methods',
          location: 'Double Bay, NSW',
          price: 'From $1495',
          provider: 'Caroline Johnson',
          center: "Mummy's Whispers",
        ...
        },
        {
          ...
          description: 'Comprehensive postpartum recovery support for new mothers and families',
          location: 'Double Bay, NSW',
          price: 'From $250',
          provider: 'Caroline Johnson',
          center: "Mummy's Whispers",
    ...
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          description:
            'Professional travel support for domestic and international flights with infants',
          location: 'Double Bay, NSW',
          price: 'From $150',
          provider: 'Caroline Johnson',
          center: "Mummy's Whispers",
    ...
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          description: '24-hour professional maternity nurse care for complex needs and multiples',
          location: 'Double Bay, NSW',
          price: 'From $316/day',
          provider: 'Caroline Johnson',
          center: "Mummy's Whispers",
        ...
        },
        {
          ...
          description:
            'Specialized support for families with twins, triplets or higher-order multiples',
          location: 'Double Bay, NSW',
          price: 'From $350',
          provider: 'Caroline Johnson',
          center: "Mummy's Whispers",
    ...
    },
    {
      ...
      description: 'Specialized health and nutrition services for adults',
      familyMember: 'For You',
      icon: Stethoscope,
      iconColor: 'text-green-600',
      bgColor: 'bg-green-50',
      services: [
        {
          title: 'Comprehensive Kidney Health Consultation at Kidney Nutrition with Jessica Dawson',
          description: 'Expert nutrition assessment and management for kidney disease prevention',
        ...
        },
        {
          ...
          description: 'Specialized nutrition plans to prevent kidney stone formation',
          location: 'Melbourne, VIC',
          price: 'From $140',
          provider: 'Jessica Dawson',
          center: 'Kidney Nutrition',
        ...
        },
        {
          ...
          description:
            'Personalized nutrition advice for building healthier lifestyles with practical, simple solutions',
        ...
        },
        {
          ...
          description:
            'Virtual nutrition consultations for convenient, personalized nutrition planning',
          location: 'Online',
          price: 'From $160',
          provider: 'Peta Carige',
          center: 'Start Training Stafford',
    ...
    },
    {
      ...
      description: 'Elite sports nutrition and performance optimization',
      familyMember: 'For Athletes & Active Families',
      icon: Trophy,
      iconColor: 'text-purple-600',
      bgColor: 'bg-purple-50',
      services: [
        {
          title: 'Performance Nutrition Consultation at Start Training with Peta Carige',
          description:
            'Elite sports nutrition for athletes and active individuals to optimize training and competition performance',
          location: 'Stafford, QLD',
          price: 'From $180',
          provider: 'Peta Carige',
          center: 'Start Training Stafford',
        ...
        },
        {
          ...
          description:
            'Specialized nutrition programs for rugby league, rugby sevens and team-based sports',
          location: 'Stafford, QLD',
          price: 'From $250',
          provider: 'Peta Carige',
          center: 'Start Training Stafford',
        ...
        },
        {
          ...
          description:
            'Weekly meal plans optimized for training adaptations and competition performance',
          location: 'Stafford, QLD',
          price: 'From $120',
          provider: 'Peta Carige',
          center: 'Start Training Stafford',
        ...
        },
        {
          ...
          description:
            'Expert workplace wellness presentations on nutrition, performance and mental health',
