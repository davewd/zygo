...
const SignUp = (props: Props) => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Signup call handled successfully');
    } catch (error) {
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="animate-fade-in">
          <div className="flex vertical-center flex-col items-center justify-center mb-6">
            <h2 className="text-6xl md:text-4xl font-bold text-gray-800">Sign Up</h2>
            <p className="text-lg md:text-base text-gray-600 mt-2">
              Join our community and start your journey with Zygo today!
            </p>
            <form onSubmit={handleSignUp} className="mt-8 w-full max-w-md">
              <input
                type="email"
                id="email"
                name="email"
