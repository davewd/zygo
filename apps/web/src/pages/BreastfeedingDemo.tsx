      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Breastfeeding Progress Tracker
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            A comprehensive feed list item component designed to help track and visualize 
            breastfeeding journeys with dual-axis charts showing feeding duration, happiness, 
            and comfort levels over time.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="rounded-lg border bg-white shadow-sm p-6 text-center">
            ...
            <p className="text-gray-600">Track feeding duration alongside happiness and soreness ratings</p>
          </div>

          <div className="rounded-lg border bg-white shadow-sm p-6 text-center">
            <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center mx-auto mb-4">
              <svg className="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m4 0H3a1 1 0 00-1 1v16a1 1 0 001 1h18a1 1 0 001-1V5a1 1 0 00-1-1z" />
              </svg>
            </div>
        ...
        <div className="rounded-lg border bg-white shadow-sm p-6">
          ...
          <div className="prose prose-gray max-w-none">
            <p className="text-gray-700 mb-4">
              This component is designed to be used within a feed list item context, 
              perfect for parenting apps, health tracking platforms, or social networks 
              focused on family wellbeing.
            </p>
            ...
            <p className="text-gray-700 mt-4">
              The component accepts a standard <code className="bg-gray-100 px-1 py-0.5 rounded">FeedItemTypeMap</code> object and 
              automatically generates the chart with sample breastfeeding data. 
              In a production environment, the chart data would be fetched from your backend API.
            </p>
          </div>
        </div>
      </div>
