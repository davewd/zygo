                ...
                <div className="space-y-6">
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="flex items-center text-gray-800">
                        <Activity className="w-5 h-5 mr-2 text-zygo-red" />
                        Recent Activity
                      </CardTitle>
                      <CardDescription>
                        Latest community interactions and milestones
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-3 text-sm">
                        ...
                        {recentActivity.lastMilestoneDate && (
                          <div className="flex items-center text-gray-600">
                            ...
                            <span>
                              Milestone shared: {formatDate(recentActivity.lastMilestoneDate)}
                            </span>
                          </div>
                        )}
                        <div className="flex items-center text-gray-600">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Engagement metrics and participation</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="text-center p-4 bg-zygo-red/5 rounded-lg">
                          <div className="text-2xl font-bold text-zygo-red">{stats.postsCount}</div>
                          <div className="text-sm text-gray-600">Posts</div>
                        </div>
                        <div className="text-center p-4 bg-zygo-blue/5 rounded-lg">
                          <div className="text-2xl font-bold text-zygo-blue">
                            {stats.connectionsCount}
                          </div>
                          <div className="text-sm text-gray-600">Connections</div>
                        </div>
                        <div className="text-center p-4 bg-zygo-yellow/5 rounded-lg">
                          <div className="text-2xl font-bold text-zygo-yellow">
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="flex items-center text-gray-800">
                        ...
                        About {consumer.displayName}
                      </CardTitle>
                      <CardDescription>Personal story and background</CardDescription>
                    </CardHeader>
                    <CardContent>
                      {consumer.tagline && (
                        <div className="mb-4">
                    ...
                    shouldShowField(consumer, 'interests') && (
                      <Card>
                        <CardHeader>
                          ...
                          <CardDescription>Areas of interest and discussion topics</CardDescription>
                        </CardHeader>
                        <CardContent>
                  ...
                  {consumer.followedProviders.length > 0 && (
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Healthcare and service providers in their network
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                          {consumer.followedProviders.map((provider, index) => {
                            ...
                            const providerCardData: ProviderCardData = {
                              ...
                              dateFollowed: provider.dateFollowed,
                            };
              ...
              {activeTab === 'details' && (
                <div className="space-y-6">
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="flex items-center text-gray-800">
                        <User className="w-5 h-5 mr-2 text-zygo-red" />
                        Profile Information
                      </CardTitle>
                      <CardDescription>Basic profile details and settings</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-3 text-sm">
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-orange-700 text-sm">
                              This profile has limited information visible due to parental controls
