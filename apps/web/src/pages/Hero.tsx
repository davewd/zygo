...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-40 right-20 w-16 h-16 bg-zygo-blue rounded-full opacity-50 animate-float" style={{ animationDelay: '1s' }}></div>
      <div className="absolute bottom-40 left-20 w-12 h-12 bg-zygo-mint rounded-full opacity-70 animate-float" style={{ animationDelay: '2s' }}></div>
      <div className="absolute bottom-60 right-40 w-8 h-8 bg-zygo-red rounded-full opacity-60 animate-float" style={{ animationDelay: '3s' }}></div>
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
            Building stronger connections, fostering growth, and creating lasting memories through our family-centered community network.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button variant="outline" size="lg" className="border-zygo-red text-zygo-red hover:bg-zygo-red hover:text-white px-8 py-4 text-lg rounded-full transition-all duration-300">
              Learn More
            </Button>
          </div>
        </div>
