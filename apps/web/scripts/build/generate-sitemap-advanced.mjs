...
const DATA_PATH = path.join(__dirname, '../../../data'); // Path to your data directory
...
const staticRoutes = [
  ...
  { path: '/network/services', priority: '0.7', changefreq: 'weekly' },
  { path: '/network/centers', priority: '0.7', changefreq: 'weekly' },
  { path: '/network/providers', priority: '0.7', changefreq: 'weekly' },
  { path: '/network/network-providers', priority: '0.7', changefreq: 'weekly' },
